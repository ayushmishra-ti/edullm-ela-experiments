...
Guidelines for generating grade-appropriate reading passages for Reading Literature (RL.*) and Reading Informational (RI.*) standards.

## IMPORTANT: This is a Reference Document

This file contains guidelines for generating passages. When you need a passage for RL.*/RI.* standards:
1. Read these guidelines
2. Generate the passage yourself following these guidelines
3. Include the passage in your JSON output's `passage` field
4. Continue to generate the question - DO NOT stop after the passage!

## When Passage is Needed
