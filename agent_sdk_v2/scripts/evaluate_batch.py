...
Example:
  ...
  python scripts/evaluate_batch.py -i outputs/sample_100_results.json
...
def main():
    ...
    parser.add_argument(
        "--input", "-i",
        type=Path,
        default=ROOT / "outputs" / "sample_100_results.json",
        help="Input JSON file containing {'generated_content': [...]} (default: outputs/sample_100_results.json)",
    )
    parser.add_argument(
        "--output-dir", "-o",
        type=Path,
