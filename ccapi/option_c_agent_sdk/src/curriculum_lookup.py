"""
Curriculum lookup tool for Claude Agent SDK.
...
def lookup_curriculum(substandard_id: str, curriculum_path: Path | None = None) -> dict[str, Any]:
    ...
    Args:
        ...
        curriculum_path: Path to curriculum.md file. If None, uses default location.
    ...
    if curriculum_path is None:
        # Default to the curriculum file in data/ folder
